(function($) {
  ...
  $(function() {
   ...
   // }
	...
	if ($("#po-chart").length) {
      var POChartCanvas = $("#po-chart").get(0).getContext("2d");
      var POChart = new Chart(POChartCanvas, {
        type: 'bar',
        data: {
          labels: ["Jan", "Feb", "Mar", "Apr", "May"],
          datasets: [{
      ...
      document.getElementById('po-legend').innerHTML = POChart.generateLegend();
    }
